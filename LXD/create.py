...
#Create a connection to the local LXD deamon - you can also supply a remote LXD host but this requires authentication
c = Client()
...
print "Container {} is {}".format(container.name, container.state().status)
